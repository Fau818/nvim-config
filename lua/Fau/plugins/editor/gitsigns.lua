local function _on_attach(bufnr)
  ...
  -- ==================== Preview ====================
  keymap("n", "<LEADER>gp", gitsigns.preview_hunk_inline, opts("Preview Changes Inline"))
  keymap("n", "<LEADER>gP", gitsigns.preview_hunk,        opts("Preview Changes Float"))
  ...
  -- ==================== Quickfix ====================
  keymap("n", "<LEADER>gq", gitsigns.setqflist, opts("Gitsigns: Show in List"))
...
return {
  ...
  opts = {
    ...
    current_line_blame_opts = {
      ...
      virt_text_priority = Fau_vim.settings.sign_priority.git_blame,
