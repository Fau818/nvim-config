...
local components = {
  ...
  indent = {
    function()
      ...
      local indent_type  = vim.bo.expandtab  -- true: space, false: tab
      local indent_width = vim.bo.tabstop
      local indent_show = string.format("%s %d", indent_type and Fau_vim.icons.ui.Space or Fau_vim.icons.ui.Tab, indent_width)
...
return {
  ...
  opts = {
    options = {
      ...
      refresh = {
        statusline = Fau_vim.settings.debounce.statusline,
