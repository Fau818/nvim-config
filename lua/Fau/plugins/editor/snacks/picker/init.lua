...
return {
  ...
  layouts = {  -- SEE: snacks.nvim/lua/snacks/picker/config/layouts.lua
    -- ==================== Presets ====================
    default = {
      layout = {
        box = "horizontal",
    ...
    select = { layout = { width = 0.40, min_width = 40, height = 0.25, min_height = 3 } },
  ...
  previewers = {
    ...
    file = {
      max_size = Fau_vim.file.large_file_size,
      max_line_length = Fau_vim.file.large_file_line,
  ...
  -- SEE: snacks.nvim/lua/snacks/picker/actions.lua
