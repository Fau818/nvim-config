...
return {
  ...
  opts = {
    ...
    disable_max_lines = Fau_vim.file.large_file_line,

    -- Disable aerial on files this size or larger (in bytes)
    disable_max_size = Fau_vim.file.large_file_size,
    ...
    highlight_on_jump = Fau_vim.settings.debounce.highlight,

    autojump = false,

    icons = Fau_vim.icons.kinds,
    ...
    lsp = {
      ...
      update_delay = Fau_vim.settings.debounce.lsp_symbols,
