...
if not lsp_signature_ok then Fau_vim.load_plugin_error("lsp_signature") return end
...
local config = {
  ...
  doc_lines = 5, -- This setting only take effect in insert mode, it does not affect signature help in normal
  ...
  close_timeout = 250, -- close floating window after ms when laster parameter is entered

  hint_enable = true, -- virtual hint enable
  hint_prefix = Fau_vim.icons.ui.Signature .. " ",
  hint_scheme = "@parameter",
