...
-- ==================== General ====================
Fau_vim.icons      = require("Fau.config.icons")
Fau_vim.colors     = require("Fau.config.colors")
Fau_vim.settings   = require("Fau.config.settings")

Fau_vim.file       = require("Fau.config.file")
Fau_vim.plugin     = require("Fau.config.plugin")

Fau_vim.diagnostic = require("Fau.config.diagnostic")
