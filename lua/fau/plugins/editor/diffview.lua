...
return {
  ...
  config = function()
    ...
    local config = {
      ...
      icons = {
        folder_closed = fvim.icons.ui.FolderClosed,
        folder_open   = fvim.icons.ui.FolderOpened,
      },
      signs = {
        fold_closed = fvim.icons.ui.FoldClosed,
        fold_open   = fvim.icons.ui.FoldOpened,
        done        = fvim.icons.git.FileStaged,
      },
